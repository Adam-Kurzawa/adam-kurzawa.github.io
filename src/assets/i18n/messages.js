export const messages = {
    "pl": {
        ...
        "cookies": {
            ...
            "p1": "Używamy plików cookie niezbędnych do prawidłowego działania serwisu (np. obsługa sesji, bezpieczeństwo, podstawowe funkcje strony).",
            "p2": "Za Twoją zgodą możemy również używać plików cookie analitycznych (Google Analytics), które pomagają nam analizować ruch na stronie i ulepszać jej działanie. Dane te są zbierane w sposób zagregowany i nie służą do bezpośredniej identyfikacji użytkownika.",
            "p3": "Możesz zaakceptować wszystkie pliki cookie lub odrzucić pliki cookie opcjonalne. Niezbędne pliki cookie są zawsze włączone, ponieważ są konieczne do działania serwisu."
        }
    }
}